...
namespace IT.Tangdao.Core.DaoTasks
{
    ...
    public static class TangdaoTaskScheduler
    {
        ...
        {
            if (dao == null) ArgumentNullException.ThrowIfNull(nameof(dao));
        ...
        {
            if (daoAsync == null) ArgumentNullException.ThrowIfNull(nameof(daoAsync)); _ = Task.Run(() =>
            {
        ...
        {
            if (daoAsync == null) ArgumentNullException.ThrowIfNull(nameof(daoAsync));
            if (dao == null) ArgumentNullException.ThrowIfNull(nameof(dao));
            _ = Task.Run(async () =>
            {
        ...
        {
            if (taskAction == null)
                ArgumentNullException.ThrowIfNull(nameof(taskAction));
